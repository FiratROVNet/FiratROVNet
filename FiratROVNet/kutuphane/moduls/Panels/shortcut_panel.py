...
def kisayol_paneli_olustur():
    ...
    shortcut_bg = Entity(parent=shortcut_root, model="quad", scale=(0.21, 0.112), color=color.black, z=0.04)
...
def _kisayol_paneli_kenarlari(parent):
    ...
    return (
        Entity(parent=parent, model="quad", position=(0, 0.056, -0.04), scale=(0.21, 0.002), color=border_color),
        Entity(parent=parent, model="quad", position=(0, -0.056, -0.04), scale=(0.21, 0.002), color=border_color),
        Entity(parent=parent, model="quad", position=(-0.105, 0, -0.04), scale=(0.002, 0.112), color=border_color),
        Entity(parent=parent, model="quad", position=(0.105, 0, -0.04), scale=(0.002, 0.112), color=border_color),
    )
